...
proc queueInitWithSpinlock*(q: ptr Queue; elementSize: cuint; elementCount: cuint; spinlockNum: cuint) {.importc: "queue_init_with_spinlock".}
...
proc queueInit*(q: ptr Queue; elementSize: cuint; elementCount: cuint) {.importc: "queue_init".}
...
proc queueFree*(q: ptr Queue) {.importc: "queue_free".}
...
proc queueGetLevelUnsafe*(q: ptr Queue): cuint {.importc: "queue_get_level_unsafe".}
...
proc queueGetLevel*(q: ptr Queue): cuint {.importc: "queue_get_level".}
  ## Check of level of the specified queue.
  ##
  ## \param q Pointer to a queue_t structure, used as a handle
  ## \return Number of entries in the queue

proc queueGetMaxLevel*(q: ptr Queue): cuint {.importc: "queue_get_max_level".}
...
proc queueResetMaxLevel*(q: ptr Queue) {.importc: "queue_reset_max_level".}
...
proc queueIsEmpty*(q: ptr Queue): bool {.importc: "queue_is_empty".}
...
proc queueIsFull*(q: ptr Queue): bool {.importc: "queue_is_full".}
...
proc queueTryAdd*(q: ptr Queue; data: pointer): bool {.importc: "queue_try_add".}
...
proc queueTryRemove*(q: ptr Queue; data: pointer): bool {.importc: "queue_try_remove".}
...
proc queueTryPeek*(q: ptr Queue; data: pointer): bool {.importc: "queue_try_peek".}
...
proc queueRemoveBlocking*(q: ptr Queue; data: pointer) {.importc: "queue_remove_blocking".}
