...
proc hwSetBits*(`addr`: IoRw32, mask: uint32) {.importc:"hw_set_bits".}
...
proc hwClearBits*(`addr`: IoRw32, mask: uint32) {.importc:"hw_clear_bits".}
...
proc hwXorBits*(`addr`: IoRw32, mask: uint32) {.importc:"hw_xor_bits".}
...
proc hwWriteMasked*(`addr`: IoRw32, values: uint32, writeMask: uint32) {.importc:"hw_write_masked".}
